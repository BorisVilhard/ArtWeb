const AdvertisementSection = () => {
	return (
		<div className="bg-[url('/img/Jozef.jpg')] relative w-[60%] h-[60vh] mx-auto mt-[46px] lg:mt-[86px] bg-cover bg-top bg-no-repeat rounded-2xl lg:rounded-[26px] py-10 px-[30px] lg:px-[65px] min-h-[40vh]">
			<div className='relative z-50 max-w-[548px] mr-auto h-full flex flex-col items-start'>
